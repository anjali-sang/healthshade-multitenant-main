<!-- Sidebar -->
<div class="z-10 fixed top-16 start-0 bottom-0 z-10 w-20 bg-gradient-to-b from-primary-md to-primary-dk border-e border-primary-lt dark:border-primary-dk lg:block lg:translate-x-0 lg:end-auto lg:bottom-0"
