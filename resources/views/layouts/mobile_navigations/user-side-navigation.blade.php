@php
    $menuItems = [
        ...
        [
            ...
            'title' => 'Inventory',
            'svg' =>
                '<svg version="1.1" id="Capa_1" class = "shrink-0 size-6"xmlns="http://www.w3.org/2000/svg"xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 394.257 394.257" xml:space="preserve" fill="currentColor"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <g> <g> <path style="fill:currentColor" d="M298.621,162.383h-40.987V43.82H150.29v118.562v11.711v145.995h148.332V162.383z M162,55.531 h83.924v106.852H162V55.531z M286.91,308.378H162V174.094h95.634h29.276V308.378z"></path> <path style="fill:currentColor" d="M323.991,332.777H151.811c-5.32-11.07-15.104-19.339-26.892-22.689V0H76.121v11.711h37.082v296.667 c-23.678,0-42.937,19.265-42.937,42.938c0,23.678,19.264,42.941,42.937,42.941s42.937-19.264,42.937-42.941 c0-2.288-0.234-4.563-0.609-6.828h168.455v-11.71H323.991z M113.203,382.547c-17.22,0-31.226-14.009-31.226-31.231 c0-17.212,14.012-31.227,31.226-31.227c1.493,0,3.108,0.143,4.935,0.429c11.162,1.778,20.494,9.48,24.376,20.128 c1.272,3.487,1.921,7.078,1.921,10.67C144.435,368.538,130.422,382.547,113.203,382.547z"></path><path style="fill:currentColor" d="M117.348,325.321c-1.352-0.218-2.728-0.355-4.146-0.355c-14.527,0-26.349,11.825-26.349,26.35 c0,14.523,11.822,26.348,26.349,26.348s26.349-11.824,26.349-26.348c0-3.054-0.543-6.079-1.61-9.018 C134.674,333.326,126.78,326.819,117.348,325.321z M113.203,365.953c-8.068,0-14.638-6.564-14.638-14.638 c0-8.074,6.57-14.639,14.638-14.639c0.798,0,1.57,0.092,2.319,0.206c5.229,0.835,9.604,4.442,11.419,9.423 c0.603,1.646,0.9,3.328,0.9,5.004C127.841,359.389,121.276,365.953,113.203,365.953z"></path> </g> </g> </g></svg>',
        ],
        [
...
@foreach ($menuItems as $item)
    {{-- <div class="mt-3 space-y-1 border-b-2 border-gray-200 dark:border-gray-700 pt-3">
        <x-dropdown-link class="flex justify-start items-center gap-3" href="{{ route($item['route']) }}">
            {{ __($item['title']) }}
        </x-dropdown-link>
    </div> --}}
    <div class="mt-1">
...
@endphp
        <x-dropdown-link href="{{ route($item['route']) }}" class="flex items-center gap-3 px-4 py-2 rounded-md hover:bg-gray-100 dark:hover:bg-gray-800 transition">
            <span class="w-6 h-6 text-gray-600 dark:text-gray-300">{!! $item['svg'] !!}</span>
            <span class="text-sm font-medium text-gray-800 dark:text-gray-100">{{ __($item['title']) }}</span>
        </x-dropdown-link>
    </div>
@endforeach