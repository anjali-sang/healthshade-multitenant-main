<x-modal name="edit-product-modal" width="w-100" height="h-auto" maxWidth="6xl">
    <div class="bg-white dark:bg-gray-800">
        ...
        <form wire:submit.prevent="updateProduct" class="max-h-[80vh] overflow-y-auto">
            <div class="p-8 space-y-8">
                ...
                <div class="bg-gray-50 dark:bg-gray-900 rounded-xl p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        <div>
                            <x-input-label for="edit_product_code" :value="__('Product Code')" class="text-sm font-medium text-gray-700 dark:text-gray-300" />
                        ...
                        <div class="md:col-span-2">
                            <x-input-label for="edit_product_name" :value="__('Product Name')" class="text-sm font-medium text-gray-700 dark:text-gray-300" />
                        ...
                        <div>
                            <x-input-label for="edit_product_supplier_id" :value="__('Supplier')" class="text-sm font-medium text-gray-700 dark:text-gray-300" />
                            ...
                            <x-text-input id="product_supplier" wire:model="product_supplier_id" type="text"
        class="mt-2 block w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-300 focus:border-blue-500 focus:ring-blue-500"
    ...
    @enderror
                        ...
                        <div>
                            <x-input-label for="edit_manufacture_code" :value="__('Manufacturing Code')" class="text-sm font-medium text-gray-700 dark:text-gray-300" />
                        ...
                        <div>
                            <x-input-label for="edit_category" :value="__('Product Category')" class="text-sm font-medium text-gray-700 dark:text-gray-300" />
                            <select wire:model="category_id" id="edit_category" 
                                class="mt-2 block w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-300 focus:border-blue-500 focus:ring-blue-500">
                        ...
                        <div>
                            <x-input-label for="edit_cost" :value="__('Product Cost')" class="text-sm font-medium text-gray-700 dark:text-gray-300" />
                        ...
                        <div>
                            <x-input-label for="edit_price" :value="__('Product Price')" class="text-sm font-medium text-gray-700 dark:text-gray-300" />
                            <div class="relative mt-2">
                                <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                    <span class="text-gray-500 text-sm">{{ $organization?->currency }}</span>
                                </div>
                ...
                <div class="bg-blue-50 dark:bg-gray-900 rounded-xl p-6">
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-lg p-4 mb-4">
                        <div class="flex items-center gap-4">
                            <div class="flex-1">
                                <x-input-label for="edit_base_unit" :value="__('Base Unit')" class="text-sm font-medium text-gray-700 dark:text-gray-300" />
                ...
                <div class="bg-purple-50 dark:bg-gray-900 rounded-xl p-6">
                    ...
                    <div class="space-y-6">
                        <!-- Description -->
                        <div>
                            <x-input-label for="edit_product_description" :value="__('Description')" class="text-sm font-medium text-gray-700 dark:text-gray-300" />
                            <textarea id="edit_product_description" wire:model="product_description" rows="4"
                        ...
                        @if ($existingImage)
                            <div>
                                <x-input-label :value="__('Current Image')" class="text-sm font-medium text-gray-700 dark:text-gray-300" />
                        ...
                        <!-- Product Images -->
                        <div>
                            <x-input-label for="edit_images" :value="__('Update Product Images')" class="text-sm font-medium text-gray-700 dark:text-gray-300" />
                            <div class="mt-2 border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-lg p-6 text-center hover:border-blue-400 transition-colors">
                                <input type="file" id="edit_images" wire:model="images" multiple accept="image/jpeg, image/png, image/webp"
                        ...
                        <div class="flex items-center gap-3 p-4 bg-yellow-50 dark:bg-yellow-900/20 rounded-lg border border-yellow-200 dark:border-yellow-800">
                            <input class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500" 
                                id="edit_isBatch" type="checkbox" wire:model="isBatch">
                            <x-input-label for="edit_isBatch" :value="__('This product has batch and expiry date?')" class="text-sm font-medium text-gray-700 dark:text-gray-300" />
                            @error('isBatch')
            ...
            <div class="px-8 py-6 bg-gray-50 dark:bg-gray-900 border-t border-gray-200 dark:border-gray-700 flex justify-end gap-4">
                ...
                <x-primary-button class="px-8 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg font-medium transition-colors" 
                    ...
                    <span x-show="!loading">{{ __('Update Product') }}</span>
